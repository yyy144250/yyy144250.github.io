            ...
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "略懂html/css/js|php|python，但是又都半吊子"
                        }).then(function() {
                            botui.message.add({
                                delay: 1500,
                                content: "对网络安全，人工智能都很感兴趣可是没有勇气学习"
                            }).then(function() {
                                botui.message.add({
                                    delay: 1800,
                                    content: "喜欢看动漫，希望有一天能cos一个角色"
                                }).then(function() {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
